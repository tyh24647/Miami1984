...
float4 skyCube = texCUBE(_Tenkoku_SkyCube,mul(_Tenkoku_CameraMV, float4(normalValues, 0)).xyz);
     ...
     //overcast color
     //half3 overcastCol = lerp(half3(skyColor.r,skyColor.r,skyColor.r),_Tenkoku_overcastColor.rgb,_Tenkoku_overcastColor.a*0.25);
     //overcastCol.rgb = lerp(overcastCol.rgb,overcastCol.rgb*0.1,_Tenkoku_overcastColor.a * (1-_Tenkoku_AmbientGI));
     //skyColor.rgb = lerp(skyColor.rgb,overcastCol*lerp(1.0,0.5,_Tenkoku_overcastColor.a),_Tenkoku_overcastColor.a*(1.0-fogFac));
...
fCol.rgb = lerp(fCol.rgb,fCol.rgb*0.5,_Tenkoku_overcastColor.a);
