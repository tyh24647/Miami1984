...
Properties {
 ...
 //_FoamColor ("Foam Color", Color) = (0.0, 0.0, 0.0, 0.0)
 _CausticsColor ("Caustics Color", Color) = (1.0,1.0,1.0,1.0)
 _UnderwaterColor ("Caustics Color", Color) = (1.0,1.0,1.0,1.0)
 
 _HeightTex ("Shallow Wave Height Texture", 2D) = "white" {}
 _NormalTex ("Shallow Wave Normal Texture", 2D) = "white" {}
 _HeightTexD ("Deep Wave Height Texture ", 2D) = "white" {}
 _NormalTexD ("Deep Wave Normal Texture Large", 2D) = "white" {}
 _HeightTexR ("Rolling Wave Height Texture ", 2D) = "white" {}
...
//SCALE SURFACE DX9 and DX11
SubShader {
 Tags { "Queue"="Geometry+50" "IgnoreProjector"="True" "RenderType"="SuimonoWater" }
 ...
 CGPROGRAM
     ...
     #pragma target 3.0
     #pragma multi_compile __ SUIMONO_DYNREFL_ON
     #pragma multi_compile __ SUIMONO_TRANS_ON
     #pragma multi_compile __ SUIMONO_CAUST_ON
     #pragma multi_compile SUIMONO_REFL_OFF SUIMONO_REFL_SKY SUIMONO_REFL_CUBE SUIMONO_REFL_COLOR 

     #pragma surface SuimonoSurf SuimonoLight addshadow
 ...
 CGPROGRAM
     ...
     #pragma target 3.0
     #pragma multi_compile __ SUIMONO_FOAM_ON
     #pragma multi_compile __ SUIMONO_TRANS_ON

     #pragma surface SuimonoSurfFoam SuimonoLightFoam addshadow alpha
