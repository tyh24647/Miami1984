Shader "Suimono2/water_under_pro_dx11" {
...
// ---------------------------------
Tags {"RenderType"="Opaque" "Queue"= "Overlay+20"} //overlay+1
...
inline fixed4 LightingSuimonoDepth (SurfaceOutput s, fixed3 lightDir, half3 viewDir, fixed atten)
{
	...
	half wavealpha = 1.0 * saturate(lerp(0.6,5.0,dot(s.Normal,viewDir)));
...
void surf (Input IN, inout SurfaceOutput o) {
	...
	origBGColor = tex2Dproj(_GrabTexture, UNITY_PROJ_COORD(uv2));
