...
public static class vp_LocalPlayer {
    ...
    public static void ShowCrosshair() {
        ...
        if (CrosshairTexture != InvisibleTexture)
            return;
    ...
    public static void HideCrosshair() {
        ...
        CrosshairTexture = InvisibleTexture;
    ...
    public static Texture InvisibleTexture {
        get {
            return InvisibleTexture1;
        }

        set {
            InvisibleTexture1 = value;
        }
    }

    public static Texture InvisibleTexture1 {
        get {
            return m_InvisibleTexture;
        }

        set {
            m_InvisibleTexture = value;
        }
    }
