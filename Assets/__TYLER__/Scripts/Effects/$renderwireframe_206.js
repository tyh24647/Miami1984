...
{ 
   ...
   if(!meshRenderer) meshRenderer = targetObject.gameObject.AddComponent(MeshRenderer); 
   ...
   var filter : MeshFilter = targetObject.GetComponent(MeshFilter); 
...
{     		
   ...
   GL.PushMatrix(); 
   GL.MultMatrix(targetObject.localToWorldMatrix); 
   GL.Begin(GL.LINES); 
   GL.Color(lineColor); 
